...
from keras.layers import BatchNormalization, Activation, Conv2D, concatenate, Conv2DTranspose, Reshape

from gta_segnet import loss
...
def get_model(input_height, input_width, n_classes):
    model = MobileUNet(input_shape=(input_height, input_width, 3),
                       alpha=1,
                       alpha_up=1,
                       depth_multiplier=1,
                       n_classes=n_classes)
